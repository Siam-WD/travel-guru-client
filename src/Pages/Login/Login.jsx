    ...
    <div className="relative mt-5 flex flex-col justify-center max-h-screen overflow-hidden">
      <div className="w-full p-6 m-auto bg-white rounded-md shadow-xl lg:max-w-xl">
        ...
        <div className="flex mt-4 gap-x-2">
          ...
          >
           <img className="h-5" src="https://i.ibb.co/fx3LWKW/google.png" alt="" />
          </button>
          <button className="flex items-center justify-center w-full p-2 border border-gray-600 rounded-md focus:ring-2 focus:ring-offset-1 focus:ring-yellow-600">
            <img className="h-5" src="https://i.ibb.co/qnMH5wK/fb.png" alt="" />
          </button>
        ...
        <p className="mt-8 text-xs font-light text-center text-gray-700">
          ...
          <Link to="/registration" className="font-medium text-yellow-600 hover:underline">
            Registration
          </Link>
        </p>
      </div>
